...
- Update changelog generated for flutter_heyteacher_store-1.29.19+1026 ([9643b0b](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/9643b0bc92595393aee1315c8ee78e8bb6855bf8))
...
- Implement caching mechanism using shared_preferences in Store class ([9c11827](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/9c11827e04f0692abed4d87dc6bf666f093fef4e))
- Add cache reset functionality in Store class ([e34a93c](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/e34a93c9eb3ae51465bbc8853bf74fc36abfdc33))
...
- Improve cache retrieval logic in Store class ([9854dcc](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/9854dcc56ac0c5f390f51d346314ff051e643d4c))
- Enhance cache logging with runtime type and hash code ([eff6cc6](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/eff6cc6b7d8289e9a14fb878397b13f6f217becd))
- Enhance logging to include runtime type in Store class ([0b858df](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/0b858df8d2d72c2544975620fa51a63a42171cae))
- Add synchronized package to dependencies ([e6080bd](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/e6080bddabff6d57a8bfc8cc49d089e838ef83c0))
- Enhance logging in StoreCache to include runtime type in log messages ([50d2be0](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/50d2be0b65f5ccf2c809804f67d8622251630fd0))
- Update synchronized calls in StoreCache methods to support async operations ([40bfb36](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/40bfb369dc66da283830a6cec28ccf238b78ca8a))
- Update StoreCache methods to use Lock for synchronized operations ([c0c8f73](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/c0c8f7383da3edc6ebb8845ba8fb6449bed78ec8))
- Simplify StoreCache methods by removing unnecessary locking ([0e14ff5](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/0e14ff59078a02fb5730311888e8d592e23744d0))
- Refactor StoreCache to support multiple data types and improve cache management ([a95af16](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a95af1629e9dd2f44016f1afd04568d17d58012d))
- Refactor StoreCache to use periodic stream for cache clearing and remove listener ([816c415](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/816c415cc689c6e3039024ceeba18cf1d7de8641))
- Update setAAD method call to use named parameter ([79b074f](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/79b074f97ec79a416da5248f10f2ee756ae76422))
- Update intl dependency version to ^0.20.2 ([d200a3e](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/d200a3e896da72db7835f88b9002ba5faa66997f))
- Rename initAggregatesStream to _initAggregatesStream and call it during initialization ([83c13c8](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/83c13c8dc36eeaeee1298766843b135563513b59))
- Update flutter_heyteacher_utils dependency to use local path ([ce6900e](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/ce6900ef9d3bc9a8a4b6f75a691eab1a543d6177))
- Correct arrayContains filter assignment in ValueStoreFilter ([3c43042](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/3c430425d0c61428f8799972c380a1271069ca33))
- Handle FirebaseException for unavailable errors in Store class ([a970522](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a970522567ebee9c495ae73b8f7ebe7b139d60ee))
- Correct logical filter string representation in toString method ([a1ae92c](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a1ae92c0ba6c9e30379ba3733c9ff36375511dc3))
- Apply order by only if `limit` != 1 ([77b102d](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/77b102dc128e9b4b0f9529aa12dfd5a5c01fac0a))
- `batch` parameter of `delete`, `update` and `set` become `dynamic` to avoid add firestore dependencies ([339f164](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/339f1643df5aa6e8c0109d4819c6e126feb56e78))
- Remove `webcrypto` from dependencies ([b6b140d](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b6b140da5384a683daa9dce17deef19894861209))
- Upgrade `webcrypto` to git reps to fix 16 KB issue on release app in production ([eaa9bf7](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/eaa9bf71eda0527132106bef5e540d2c320230c0))
- `storeFilter` logging in`Store.listDetails` ([1f684aa](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/1f684aa8e76b577ae44dd8ac7684125d84115fe1))
- Remove `*.lock` ignored ([138bf03](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/138bf033e234f702d36a8e136ff01ef96f8c3731))
- Remove skip on order by if `limit` is 1 ([b31f75a](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b31f75a08376417187b021073b74bad41b02b57e))
...
- Change log level from fine to finest for detailed logging in Store class ([fd01e48](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/fd01e4835516f9db47c536c6955c9e1d1f5d917d))
- Improve logging messages in cache retrieval and data fetching methods ([0990ef3](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/0990ef3cc4a86cecd89974064e0b586043aa475b))
- Enhance exists method to handle document retrieval exceptions ([8116549](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/81165498b91ccac89901c5a4e3c831c195680c32))
- Change detailsData type to dynamic in detailed data cache ([156da9f](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/156da9f0e50e27f64598772bed5a94143f81a457))
- Format code for better readability in _getCached and _updateCache methods ([d0ca2bf](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/d0ca2bf4dc5ac1c01e4815ea951ae931c7b7399e))
- Streamline cache key generation in _getCached, _updateCache, and _removeCache methods ([b59f9d6](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b59f9d64490592c5f8a6c57313bc2756b8244494))
- Improve cache management and logging in Store class ([86583b5](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/86583b5eea4274d7fe68db460bf2a85a830a3dbc))
- Remove UserStore implementation and related tests ([8991416](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/8991416315fc494be893e5ed18e6efd080590342))
- Update cache handling to use private fields for cache and offline settings ([2521269](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/25212690be4dbade67fd55c81cd60ed846e140f3))
- Streamline aggregate initialization and update notification logic ([cb8b6d6](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/cb8b6d613812dac7aaec521521fbd473aa8615cd))
- Simplify StoreCache class by removing unused LightDataType and renaming methods for clarity ([ec82c12](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/ec82c12711ea7d0c64fe252d49f39f8b3bbb0a56))
- Rename logger variable for consistency in StoreCache class and add $runtimeType. in each log in order to indentify store name ([b1752ed](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b1752ed3db8794d901f145798b2187a236f8ac1e))
- Rename *ModelView to *ViewModel ([a6b0dba](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a6b0dba4aa3232dbdbde4ce60cd94ddcf93c9fd6))
...
- Update CHANGELOG.md with release 1.29.1+260220154 ([2b5b84f](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/2b5b84f90f25023ef0e629dc962d555313b66dd1))
- Update CHANGELOG.md with release 1.29.2+260221102 ([a1102b7](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a1102b70aaab87cedf3154b7ec873e66de5744fb))
- Update CHANGELOG.md with release 1.29.3+260225090 ([e146f19](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/e146f190a3cf2395a24f1df13304155a17ee015d))
- Update CHANGELOG.md with release 1.29.4+260225162 ([b9d4b84](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b9d4b8459fcbde12be8a3a5e51025d08e31c1c8b))
- Update CHANGELOG.md with release 1.29.6+260226194 ([fec0b85](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/fec0b85e5e4ca1632425a0802c4e8646629b5ba1))
- Update CHANGELOG.md with release v1.29.7+1001 ([3981252](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/3981252df417bc9ac25402bd89095551e3488509))
- *(CHANGELOG)* Update CHANGELOG.md with release v1.29.8+1003 ([df82d30](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/df82d30a5cf32cb18d42bb979bb7ba2863c5f9b8))
- *(CHANGELOG)* Update CHANGELOG.md with release v1.29.8+1004 ([b6b1746](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b6b1746914ab74d1c7342fbe1bbae43d584d74ba))
- Add `README.md` and update dart doc in `Store`, move in separated dart file `TrackStore` in unit tests ([b734795](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/b73479536e53ff8441a90a19adaaabc39c5654e7))
...
- Update version and add package_info_plus dependency ([467df30](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/467df304854563280f1970595241ee0a4d341e53))
- Update aws-sdk and faraday dependencies to latest versions ([a0443be](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/a0443be48f1d8938d0fe6d4c7d40521e5e6946a3))
- Use `flutter_heyteacher_meta` from pub cache ([0fae456](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/0fae45686c6dd22be2f56abfe1eb46c4813612d1))
- *(store)* Add local dependency to `flutter_heyteacher_text_to_speech` ([83f5d8d](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/83f5d8ddbb9bd34efea0c6d5dcf5ddfa971ac679))

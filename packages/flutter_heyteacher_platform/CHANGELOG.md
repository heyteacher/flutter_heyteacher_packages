...
- *(flutter_heyteacher_platform)* Update version to 2.0.7+140 which closes #tmp
...
- *(flutter_heyteacher_platform)* Update `CHANGELOG.md` with flutter_heyteacher_platform-2.0.6+138
...
- *(CHANGELOG)* Update CHANGELOG.md with release flutter_heyteacher_platform-2.0.4+134
...
- *(CHANGELOG)* Update CHANGELOG.md with release flutter_heyteacher_platform-2.0.3+132
...
- *(CHANGELOG)* Update CHANGELOG.md with release flutter_heyteacher_platform-2.0.2+130
## [flutter_heyteacher_platform-2.0.1+128] - 2026-03-07

### 🐛 Bug Fixes

- *(plaftorm)* `LoggerViewModel.instance` become getter
...
- *(CHANGELOG)* Update CHANGELOG.md with release flutter_heyteacher_platform-2.0.1+128
...
- *(CHANGELOG)* Update CHANGELOG.md with release flutter_heyteacher_platform-2.0.0+126

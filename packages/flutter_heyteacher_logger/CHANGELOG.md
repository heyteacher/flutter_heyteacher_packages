...
- [**breaking**] Remove `Card` wrapper to ListTile widgets and rename  `*ListTile` and reorganize internal implementation splitting in `data`, `view` and `view_model` folder ([3673576](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/3673576167b232680646149a28e841eacb8ccd45))

### ⚙️ Miscellaneous Tasks [3.0.0]

- *(release)* New version 3.0.0+157 which closes ([#167](https://codeberg.org/heyteacher/flutter_heyteacher_packages/issues/167)) ([f2afe53](https://codeberg.org/heyteacher/flutter_heyteacher_packages/commit/f2afe532e792c2d9877f55f840ae8323610ede36))

        ...
        AspectRatio(
          aspectRatio: !rotate
              ...
              : switch (chartDataList.length) {
                  1 => _smallScreen ? 4.5 : 4.5 * 1.8,
                  2 => _smallScreen ? 2.75 : 2.75 * 1.8,
                  3 => _smallScreen ? 2.25 : 2.25 * 1.8,
                  4 => _smallScreen ? 1.4 : 1.4 * 1.8,
                  _ => (_smallScreen ? 8 : 8 * 2.5) / chartDataList.length,
                },
          child: BarChart(
            BarChartData(
                  ...
                  getTooltipItem: (group, groupIndex, rod, rodIndex) =>
                      BarTooltipItem(
                        formatterY?.call(
                            ...
                            '',
                        TextStyle(color: rod.color, height: 0.9, fontSize: 10),
                      ),
                ),
              ),
              maxY: maxY,

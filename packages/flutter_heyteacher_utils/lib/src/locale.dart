...
class LocaleModel {
  ...
  LocaleModel._() {
    ...
    SharedPreferencesAsync().getString(_sharedPreferencesLocaleKey).then((localeName) {
  ...
  set locale(Locale? newLocale) {
    _locale = newLocale;
    if (newLocale != null) {
      SharedPreferencesAsync().setString(_sharedPreferencesLocaleKey, newLocale.languageCode);

...
class E2EE {
  ...
  Future<String> decrypt(E2EEValue encrypted) async {
    ...
    // decrypt value
    final decryptedBytes = await secretKey
        .decryptBytes(encrypted.value, encrypted.iv, additionalData: aadBytes);
...
class MissingSecretKeyInSecureStorageException implements Exception {}
